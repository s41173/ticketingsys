...
<script src="<?php echo base_url(); ?>js/moduljs/transfer.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('transfer/add_process/');?>";
	var sites_edit = "<?php echo site_url('transfer/update_process/');?>";
	var sites_del  = "<?php echo site_url('transfer/delete/');?>";
	var sites_get  = "<?php echo site_url('transfer/update/');?>";
    var sites_ajax  = "<?php echo site_url('transfer/');?>";
