...
//        elseif ($paid == '0'){ $this->db->where('paid_date IS NULL'); }
    ...
    {   
        $this->db->select("sales.id, sales.code, sales.dates, sales_item.passenger, sales_item.source, sales_item.dates as depart_dates, sales_item.source_desc,  
                           sales_item.destination, sales_item.destination_desc, sales_item.returns, sales_item.return_dates, sales_item.ticketno,
                           sales_item.airline, sales_item.bookcode, sales_item.country, sales_item.price, sales_item.amount, sales_item.hpp, sales_item.discount, sales_item.tax,
