...
<form id="edit_form_non" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="<?php echo $form_action_confirmation; ?>" 
  ...
  <input id="ds3" class="form-control col-md-8 col-xs-12" type="text" name="tcdates">
     <input type="hidden" name="hid" id="hid">
      </div> 
    </div>
    
    <div class="form-group">
      <label for="middle-name" class="control-label col-md-3 col-sm-3 col-xs-12"> CC-Name </label>
      <div class="col-md-6 col-sm-12 col-xs-12">
  <input id="tccname" class="form-control col-md-7 col-xs-12" type="text" name="tccname" placeholder="Acc Name">
      </div>
    </div>

      <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> CC-No <span class="required">*</span></label>
          <div class="col-md-6 col-sm-12 col-xs-12">
  <input id="tccno" class="form-control col-md-7 col-xs-12" type="text" name="tccno" placeholder="Acc No">
          </div>
      </div>
    
      <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name"> CC-Bank <span class="required">*</span></label>
          <div class="col-md-6 col-sm-6 col-xs-12">
 <input id="tccbank" class="form-control col-md-7 col-xs-12" type="text" name="tccbank" placeholder="Bank">   
          </div>
      </div>
 ...
 <input type="number" id="tamount" class="form-control col-md-3 col-xs-12" type="text" name="tamount" placeholder="Amount">   
      ...
      <div class="col-md-7 col-sm-12 col-xs-12">
	      ...
	      echo form_dropdown('cbank', $bank, isset($default['account']) ? $default['account'] : '', $js); ?>
      </div>
      </div>
