...
<script src="<?php echo base_url(); ?>js/moduljs/service.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('service/add_process/');?>";
	var sites_edit = "<?php echo site_url('service/update_process/');?>";
	var sites_del  = "<?php echo site_url('service/delete/');?>";
	var sites_get  = "<?php echo site_url('service/update/');?>";
    var sites_get_item  = "<?php echo site_url('service/update_item/');?>";
    var sites  = "<?php echo site_url('service');?>";
...
<!-- div tgl transaksi -->
    <div class="col-md-2 col-sm-12 col-xs-12">
       ...
       <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <input type="text" title="Due Date" class="form-control" id="ds0" name="tduedates" required 
...
<div class="row">
 ...
 <!-- searching form -->
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_trans; ?>">
       ...
       <div class="form-group">
        <label class="control-label labelx"> CheckIn / CheckOut </label> <br>
        <table>
        <tr>
         <td> <input type="text" title="Date" class="form-control" id="ds3" name="tcheckin" required
           value="<?php echo isset($default['dates']) ? $default['dates'] : '' ?>" />  &nbsp; </td>
        </tr>
             <tr>
         <td> <input type="text" title="Date" class="form-control" id="ds4" name="tcheckout" required
           value="<?php echo isset($default['dates']) ? $default['dates'] : '' ?>" /> </td>
             </tr>
             <tr>
         <td>
             <input type="text" class="form-control" id="tbook" name="tbook" placeholder="BookCode" style="margin-top:5px;"> <br> <input type="checkbox" name="ckservice" id="ckservice" value="1"> <small> Service </small>
         </td>
             </tr>
         </table>
      ...
      <div class="form-group">
        <label class="control-label labelx"> Vendor &amp; Description </label> <br>
        
        <table>
            <tr>
                <td> 
                  <?php $js = "class='select2_single form-control' id='cvendor' tabindex='-1' style='min-width:250px;' "; 
	              echo form_dropdown('cvendor', $vendor, isset($default['vendor']) ? $default['vendor'] : '', $js); ?> 
	            </td>
            </tr>
            <tr>
                <td> 
                <textarea class="form-control col-md-3 col-xs-12" id="tdesc" name="tdesc" style="width:250px; margin-top:5px;"></textarea> &nbsp;
	            </td>
            </tr>
        </table>
      </div>
      ...
      <div class="form-group">
        <label class="control-label labelx"> Capital &amp; Price </label> <br>
        
        <table>
        <tr>
         <td>  <input type="number" name="tcapital" id="tcapital" class="form-control" style="width:110px;" maxlength="8" required value="0"> &nbsp; </td>
        </tr>
             <tr>
         <td>  <input type="number" name="tprice" id="tprice" class="form-control" style="width:110px; margin-top:5px;" maxlength="8" required value="0"> &nbsp; </td>
             </tr>
         </table>
      ...
      <div class="form-group">
        <label class="control-label labelx"> Discount &amp; Tax </label> <br>
        
        <table>
        <tr>
         <td> <input type="number" name="tdiscount" id="tdiscount" class="form-control" style="width:110px;" maxlength="8" required value="0"> &nbsp; </td>
        </tr>
             <tr>
         <td>  <?php $js = "class='form-control' id='ctax' tabindex='-1' style='width120px; margin-top:5px;' "; 
	     echo form_dropdown('ctax', $tax, isset($default['tax']) ? $default['tax'] : '', $js); ?> </td>
             </tr>
         </table>
      </div>   
                ...
                foreach($items as $res)
                {
                    echo "
                     <tr class=\"even pointer\">
                        ...
                        <td> ".tglin($res->checkin)." - ".tglin($res->checkout)."</td>
...
<a class=\"btn btn-danger btn-xs\" href=\"".site_url('service/delete_item/'.$res->id.'/'.$res->service_id)."\"> 
...
<!-- form transaction table  -->  
  ...
  <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('service_update_item'); ?>      
  </div>
      <!-- Modal - Add Form -->
