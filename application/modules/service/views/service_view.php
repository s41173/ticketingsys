...
<script type="text/javascript">
    ...
    var sites_confirmation  = "<?php echo site_url('service/confirmation/');?>";
    var sites_print_invoice  = "<?php echo site_url('service/invoice/');?>";
    var sites_primary   = "<?php echo site_url('service/publish/');?>";
	var sites_attribute = "<?php echo site_url('service/attribute/');?>";
          ...
          <div class="row"> 
           ...
           <form id="searchform" class="form-inline">
            ...
            <div class="form-group">
                ...
                <?php $js = "class='select2_single form-control' id='ccustomer' tabindex='-1' style='min-width:200px;' "; 
...
<form class="form-inline" id="cekallform" method="post" action="<?php echo ! empty($form_action_del) ? $form_action_del : ''; ?>">
      ...
      <!-- Check All Function -->
            ...
            <div class="btn-group">
<a class="btn btn-primary" href="<?php echo site_url('service/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New </a>
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal3"> Report  </button>
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('service_confirmation'); ?>      
      </div>
      <!-- Modal - Add Form -->      
      
      <!-- Modal - Report Form -->
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('service_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
