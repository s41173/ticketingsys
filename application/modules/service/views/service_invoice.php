...
<div id="container">
	...
	<h2 style="font-size:1.4em; font-weight:normal; text-align:center; margin:0px 0px 10px 0px; padding:0 0 0 25px;"> 
	  SALES SERVICE ORDER RECEIPT </h2> 
	<div style="clear:both; "></div> 
	<div style="clear:both; "></div>
	...
	<div style="margin:10px; border-bottom:1px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> 
<th> No </th> <th> Passenger </th> <th> Book Code </th> <th> Description </th> 
<th> Amount </th>
		 </tr>
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						...
						<td> ".$res->bookcode." </td>
                        <td class=\"left\"> ".$res->description." </td> 
		 ...
		 <tr> <td class="right" colspan="4"> Landed Cost : </td> <td class="right"> <?php echo number_format($cost); ?>,- </td> </tr>
<tr> <td colspan="4" class="right"> <b> Total : </b> </td> <td class="right"> <b> <?php echo number_format($amount); ?>,- </b> </td> </tr>
