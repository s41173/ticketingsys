...
<script src="<?php echo base_url(); ?>js/moduljs/apc.js"></script>
<script src="<?php echo base_url(); ?>js-old/register.js"></script>

<script type="text/javascript">

	var sites_add  = "<?php echo site_url('apc/add_process/');?>";
	var sites_edit = "<?php echo site_url('apc/update_process/');?>";
	var sites_del  = "<?php echo site_url('apc/delete/');?>";
	var sites_get  = "<?php echo site_url('apc/update/');?>";
    var sites  = "<?php echo site_url('apc/');?>";
...
<div class="row">
 ...
 <!-- searching form -->
   ...
   <form id="ajaxtransform" class="form-inline" method="post" action="<?php echo $form_action_item; ?>">
      <div class="form-group">
        <label class="control-label labelx"> Cost Type </label> <br>
<?php $js = "class='select2_single form-control' id='ccost' tabindex='-1' style='min-width:120px;' "; 
echo form_dropdown('ccost', $cost, isset($default['cost']) ? $default['cost'] : '', $js); ?>
          &nbsp;
      </div>
      
      <div class="form-group">
        <label class="control-label labelx"> Notes </label> <br>
        <textarea name="tnotes" id="tnotes" class="form-control" rows="2" cols="25" placeholder="Cost Notes"></textarea> &nbsp;
      </div>   
       
      <div class="form-group">
        <label class="control-label labelx"> Receiver </label> <br>
        <input type="text" name="tstaff" id="staff" class="form-control" style="width:150px;" required> &nbsp;
      </div>   
      ...
      <table class="table table-striped jambo_table bulk_action">
        <thead>
          <tr class="headings">
            ...
            <th class="column-title"> Cost Type </th>
