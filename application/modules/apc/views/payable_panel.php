...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Payable Card </h4>
</div>
...
action="<?php echo site_url('apc/payable_process'); ?>" enctype="multipart/form-data">
...
<?php $js = "class='form-control' id='cvendor' tabindex='-1' style='width:200px;' "; 
      echo form_dropdown('cvendor', $vendor, isset($default['customer']) ? $default['customer'] : '', $js); 
 ?>
        </div>
    </div>
