	...
	<fieldset class="field"> <legend> Account </legend>
	    <form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
            ...
            <tr>	
                ...
                <td> <input type="text" class="required" readonly="readonly" name="tno" size="5" title="Code"
            ...
            <tr>
                ...
                <td> <input type="text" class="required" name="tname" readonly="readonly" size="35" title="Name"
                     value="<?php echo set_value('tname', isset($default['name']) ? $default['name'] : ''); ?>" /> &nbsp; <br /> </td>
            </tr>
            
            <tr>
                <td> <label for="tbalance"> Balance </label> </td>  <td>:</td>
                <td> <input type="text" name="tbalance" id="tbalances" size="15" title="Balance" onKeyUp="checkdigit(this.value, 'tbalance')"
                     value="<?php echo set_value('tbalance', isset($default['balance']) ? $default['balance'] : ''); ?>" /> &nbsp; <br /> </td>
            </tr>
