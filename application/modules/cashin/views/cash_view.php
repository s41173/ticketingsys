...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('cashin/add_process/');?>";
	var sites_edit = "<?php echo site_url('cashin/update_process/');?>";
	var sites_del  = "<?php echo site_url('cashin/delete/');?>";
	var sites_get  = "<?php echo site_url('cashin/update/');?>";
    var sites_ajax  = "<?php echo site_url('cashin/');?>";
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('cashin/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New  </a>
