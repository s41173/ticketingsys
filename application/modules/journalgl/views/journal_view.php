...
<script type="text/javascript">
    ...
    var sites_ajax  = "<?php echo site_url('journalgl/');?>";
	var source = "<?php echo $source;?>";
          ...
          <div class="row"> 
           ...
           <form id="searchform" class="form-inline">
              ...
              <label> Ref : </label> <br>
<?php $js = "class='form-control' id='ccode' tabindex='-1' style='min-width:170px;' "; 
echo form_dropdown('ccode', $journal, isset($default['journal']) ? $default['journal'] : '', $js); ?>
              </div>
              
              
            <div class="form-group">
              <label> No : </label> <br>
              <input type="number" id="tno" name="tno" class="form-control" style="width:90px;">    
            </div>  
...
-->
   ...
   <div class="btn-group">
   <a class="btn btn-primary" href="<?php echo site_url('journalgl/add'); ?>"> <i class="fa fa-plus"></i>&nbsp;Add New  </a>
