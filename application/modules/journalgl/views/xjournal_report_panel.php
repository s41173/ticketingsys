...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
            ...
            <tr>	
			<td> <label for="tname"> Trans Type </label> </td> <td>:</td>
			<td> <?php $js = 'class="required"'; echo form_dropdown('cjournal', $jurnaltype, isset($default['journal']) ? $default['journal'] : '', $js); ?> &nbsp; <br /> </td>
			</tr>
