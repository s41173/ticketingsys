...
<div class="modal-header">
  ...
  <h4 class="modal-title"> Journal Report </h4>
</div>
...
<input type="text" readonly style="width: 200px" name="reservation" id="d1" class="form-control active" value=""> 
    ...
    <div class="form-group">
        <label class="control-label col-md-3 col-sm-3 col-xs-12"> Trans Type </label>
        <div class="col-md-3 col-sm-12 col-xs-12">     
            <?php $js = "class='form-control' id='ccode' tabindex='-1' style='min-width:170px;' "; 
            echo form_dropdown('cjournal', $journal, isset($default['journal']) ? $default['journal'] : '', $js); ?>
        </div>
    </div>
