...
<script src="<?php echo base_url(); ?>js/moduljs/deposit.js"></script>
...
<script type="text/javascript">
	...
	var sites_add  = "<?php echo site_url('deposit/add_process/');?>";
	var sites_edit = "<?php echo site_url('deposit/update_process/');?>";
	var sites_del  = "<?php echo site_url('deposit/delete/');?>";
	var sites_get  = "<?php echo site_url('deposit/update/');?>";
    var sites_ajax  = "<?php echo site_url('deposit/');?>";
	var source = "<?php echo $source;?>";
       ...
       <div class="form-group">
           ...
           <?php $js = "class='select2_single form-control' id='cairline_search' tabindex='-1' style='width:210px;' "; 
...
-->
   ...
   <!-- links -->
      ...
      <div class="modal fade" id="myModal" role="dialog">
         <?php $this->load->view('deposit_form'); ?>      
      </div>
      <!-- Modal - Add Form -->
              
       <!-- Modal - Add Form -->
      <div class="modal fade" id="myModal2" role="dialog">
         <?php $this->load->view('deposit_update'); ?>      
      </div>
      <!-- Modal - Add Form -->
      ...
      <div class="modal fade" id="myModal3" role="dialog">
         <?php $this->load->view('deposit_report_panel'); ?>    
      </div>
      <!-- Modal - Report Form -->
