...
enctype="multipart/form-data">
      ...
      <div class="col-md-11 col-sm-9 col-xs-12 form-group"> <br>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" title="Date" class="form-control" id="ds2" name="tdates" /> 
        </div>
      </div>
      ...
      <div class="col-md-11 col-sm-9 col-xs-12 form-group">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">    
           <?php $js = "class='select2_single form-control' id='cairline' tabindex='-1' style='width:210px;' "; 
      ...
      <div class="col-md-11 col-sm-9 col-xs-12 form-group">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">    
          <input type="text" id="tamount" name="tamount" class="form-control" placeholder="Amount">
        </div>
      </div>	
...
<td> <?php echo anchor_popup(site_url("account/get_list/"), '[ ... ]', $atts1); ?> </td>
      ...
      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
        <textarea class="form-control" name="tdesc" rows="2" placeholder="Description"></textarea>
      </div>
