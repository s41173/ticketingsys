...
// fungsi jquery update
	...
	{	
		...
		$.ajax({
			...
			success: function(result) {
				...
				$("#titem_update").val(res[1]);
				$("#ttime").val(res[2]);
				$("#tamount").val(res[3]);
				$("#tconsumption").val(res[4]);
				$("#ttransport").val(res[5]);
				$("#tbonus").val(res[6]);
				$("#tbonusremarks").val(res[7]);
				$("#tinsurance").val(res[8]);
			}
		})
		return false;	
	});
	...
	$('#searchform').submit(function() {
		...
		var division = $("#cdivision").val();
		var param = ['searching',division];
